...
#waypoints = [(0.0,0.0), (10.0, 0.0), (10.0, -10.0), (-10.0, -10.0), (0.0,0.0)]
#waypoints = [(0.0,0.0), (10.0, 0.0), (10.0, -10.0), (0.0, -10.0), (0.0,0.0)]
waypoints = [(0.0,0.0), (20.0, 0.0), (20.0, -10.0), (0.0, -10.0), (0.0, -20.0), (20.0, -20.0), (20.0, -30.0), (0.0, -30.0), (0.0,0.0)]
...
#waypoints = [(0.0,0.0), (-1.0, -5.0), (-2.0,0.0)]

#waypoints_deseados = [(0.0,0.0), (10.0, 0.0), (10.0, -10.0), (0.0, -10.0), (0.0,0.0)]
#waypoints_deseados = [(0.0,0.0), (20.0, 0.0), (20.0, -20.0), (0.0, -20.0), (0.0,0.0)]
waypoints_deseados = [(0.0,0.0), (20.0, 0.0), (20.0, -10.0), (0.0, -10.0), (0.0, -20.0), (20.0, -20.0), (20.0, -30.0), (0.0, -30.0), (0.0,0.0)]
...
for i in range(len(waypoints)):
	wpt = ( waypoints[i][0] + msg.y, waypoints[i][1] + msg.x)
	waypoints[i] = wpt
	...
	while(True):
		try: 
			...
			if  msg:
				...
				print("y:    %f" % msg.y)
				print("z:    %f" % msg.z)
				xd.append(msg.y - offset_x)
				yd.append(msg.x - offset_y) #NED to ENU
				zd.append(-msg.z + offset_z) # Arreglando el offset en z
...
plt.title('Posicion del dron en la mision')
plt.xlabel('x [m] (Este)')
plt.ylabel('y [m] (Norte)')
plt.plot(xd,yd, label='Recorrido del dron')
plt.plot(xd[0],yd[0], 'go' , label='Punto de despegue')
plt.plot(xd[len(xd)-1],yd[len(yd)-1], 'ro' , label='Punto de aterrizaje')
...
xwp, ywp = zip(*waypoints_deseados)
...
plot2 = plt.figure(3)
# Add title and axis names
plt.title('Altitud del dron en la mision')
plt.xlabel('t [s]')
plt.ylabel('z [m]')
plt.plot(t, zd, label="Altitud del dron")
plt.plot([0, t[len(t)-1]], [alt_deseada, alt_deseada], '--', label='Altitud deseada' )
plt.legend()
plt.show()
