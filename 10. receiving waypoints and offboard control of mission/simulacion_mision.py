...
# waypoints = [(mes[0],mes[1]), (mes[0]+.001,mes[1]), 
# 			(mes[0]+.001,mes[1]+.0001), (mes[0],mes[1]+.0001), 
# 			(mes[0],mes[1]+.0002), (mes[0]+.001,mes[1]+.0002), 
# 			(mes[0]+.001,mes[1]+.0003), (mes[0],mes[1]+.0003), 
# 			(mes[0],mes[1]+.0004), (mes[0]+.001,mes[1]+.0004),
# 			(mes[0]+.001,mes[1]+.0005), (mes[0],mes[1]+.0005),
# 			(mes[0],mes[1]+.0006), (mes[0]+.001,mes[1]+.0006),
# 			(mes[0]+.001,mes[1]+.0007), (mes[0],mes[1]+.0007),
# 			(mes[0],mes[1]+.0008), (mes[0]+.001,mes[1]+.0008),
# 			(mes[0]+.001,mes[1]+.0009), (mes[0],mes[1]+.0009), 
# 			(mes[0],mes[1]+.001), (mes[0]+.001,mes[1]+.001),
# 			(mes[0]+.001,mes[1]+.0011), (mes[0],mes[1]+.0011), 
# 			(mes[0],mes[1]+.0012), (mes[0]+.001,mes[1]+.0012),
# 			(mes[0]+.001,mes[1]+.0013), (mes[0],mes[1]+.0013),
# 			(mes[0],mes[1]+.0014), (mes[0]+.001,mes[1]+.0014),
# 			(mes[0]+.001,mes[1]+.0015), (mes[0],mes[1]+.0015),
# 			(mes[0],mes[1])]
...
plt.plot([0, t[len(t)-1]], [3, 3], '--', label='Velocidad maxima' )
plt.legend()
plt.show()